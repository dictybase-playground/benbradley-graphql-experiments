 ...
 * @example
 * mockGetRocketsQuery((req, res, ctx) => {
 ...
 * })
 */
export const mockGetRocketsQuery = (resolver: ResponseResolver<GraphQLRequest<GetRocketsQueryVariables>, GraphQLContext<GetRocketsQuery>, any>) =>
  graphql.query<GetRocketsQuery, GetRocketsQueryVariables>(
    'GetRockets',
    resolver
  )
